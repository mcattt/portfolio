...
const Projects = () => {
    ...
    return (
        <div
            id="projects"
            className={`min-h-screen h-auto mx-6 max-w-[1200px] desktop:mx-auto  desktop:pt-24 `}
        >
            ...
            <div className={`transition-all mt-24 mx-1 duration-1000 ${hasBeenActive ? 'opacity-100 translate-y-0 delay-200' : 'translate-y-4 opacity-0'}`}>
                <Carousel />
            </div>
        </div>
    );
