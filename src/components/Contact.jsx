    ...
    return (
        ...
        ' >
            ...
            <div className='flex flex-row  justify-evenly mt-12 bg-gray-700 mx-auto py-10 rounded-2xl bg-opacity-30   max-w-lg'>
                <svg xmlns="http://www.w3.org/2000/svg" width="3.5rem" height="3.5rem" viewBox="0 0 24 24" className='gradient-svg-1 bg-white px-2  rounded-xl' >
                    <defs>
                        <linearGradient id="white1" x1="0" x2="0" y1="62" y2="0" gradientUnits="userSpaceOnUse">
                            <stop offset="13%" stop-color="rgb(55 65 81)" />
                            <stop offset="100%" stop-color="rgb(55 65 81)" />
                        </linearGradient>
                    </defs>
                    <path d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l3.824 3.099 3.83-3.104 5.612 6.817h-18.779l5.513-6.812zm9.208-1.264l4.616-3.741v9.348l-4.616-5.607z" />
                </svg>

                <svg xmlns="http://www.w3.org/2000/svg" width="3.5rem" height="3.5rem" viewBox="0 0 24 24" className='gradient-svg-2 bg-white px-2  rounded-xl'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="3.5rem" height="3.5rem" viewBox="0 0 24 24" className='gradient-svg-3 bg-white px-3  rounded-xl'>
