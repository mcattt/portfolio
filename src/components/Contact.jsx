    ...
    return (
        ...
        ' >
            ...
            <div className='flex flex-row  justify-evenly mt-12 bg-gray-700 mx-auto py-10 rounded-2xl bg-opacity-30   max-w-lg'>
                <svg xmlns="http://www.w3.org/2000/svg" width="4rem" height="4rem" viewBox="0 0 24 24" className='gradient-svg-1 bg-white px-2  rounded-xl' >
                    <defs>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="4rem" height="4rem" viewBox="0 0 24 24" className='gradient-svg-2 bg-white px-2  rounded-xl'>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="4rem" height="4rem" viewBox="0 0 24 24" className='gradient-svg-3 bg-white px-3  rounded-xl'>
